package aquadrop_latam.bookingService.config;
...
public class RabbitMQConfig {
    ...
    public MessageConverter jsonMessageConverter() {
        ...
        // Configurar mapeo de tipos para aceptar eventos de otros servicios
        DefaultJackson2JavaTypeMapper typeMapper = new DefaultJackson2JavaTypeMapper();
        typeMapper.setTrustedPackages("*");
        
        // Mapear las clases de otros servicios a las clases locales
        Map<String, Class<?>> idClassMapping = new HashMap<>();
        idClassMapping.put("aquadrop_latam.payment_service.events.PaymentAuthorizedEvent", 
                          PaymentAuthorizedEvent.class);
        idClassMapping.put("aquadrop_latam.fleet_service.events.TankerAssignedEvent", 
                          TankerAssignedEvent.class);
